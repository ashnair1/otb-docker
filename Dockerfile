...
RUN wget -P /opt/ https://www.orfeo-toolbox.org/packages/OTB-8.0.0-Linux64.run && chmod +x /opt/OTB-8.0.0-Linux64.run
RUN mkdir -p /opt/otb && /opt/OTB-8.0.0-Linux64.run --target ${TARGET} &> /tmp/.otb_build.log
RUN rm /opt/OTB-8.0.0-Linux64.run
